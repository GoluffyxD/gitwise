...
let prNumber = getPullRequestNumber('d888dbeed9b715adb70a9e219410c9acfa2f9254').then(result =>{
if(result){
  const [prNumber, issueId] = result;
  console.log("PR Number and Issue ID is - " + prNumber + " and " + issueId +" respectively");
